...
export default function CreateListing() {
    ...
    return (
        <main className='p-3 max-w-4xl mx-auto'>
            <h1 className='text-3xl font-semibold text-center my-7'>Update Short Link</h1>
            <form onSubmit={handleSubmit}>
                <div className='flex flex-col gap-4 flex-1'>
                    <input type="txt" placeholder='Name' className='border p-3 rounded-lg' id='name' required onChange={handleChange} value={formData.name}/>
                    ...
                    <button type="submit" style={{width: '100%'}} className='p-3 bg-slate-700 text-white rounded-lg uppercase hover:opacity-95 disabled:opacity-80'>Update Short Link</button>
                </div>
            </form>
